...
function Modal(props) {
    ...
    return (
        <div className={styles.modal_container}>
            ...
            <p className={styles.modal_text}>Your details have been successfully submitted</p>
            <p className={styles.mobile_modal}>Your details have been <br /> successfully submitted</p>
        </div>
    )
}
