...
function Eventnoire() {
  return (
    <div className={styles.eventnoire}>
      ...
      <p className={styles.header_mobile}>EVENTNOIRE <br /> EXPERIENCES 2022</p>
      <div className={styles.eventnoire_images}>
        <div className={styles.image_container}>
          <Image className={styles.imageOne} src={ImageOne} width={539} height={324} />
        ...
        <div className={styles.image_container}>
          <Image className={styles.imageOne} src={ImageTwo} width={539} height={324} />
          <div className={styles.eventnoire_card}>
              <div className={styles.dates_display}>
                  <div className={styles.dates}>
                      <Image
