  ...
  return (
    <nav className={styles.nav}>
      <div className={styles.left_nav}>
        <Image src={Logo} width={29.44} height={27.53} />
        <p>
      ...
      <div className={styles.hamburger} onClick={clicked}>
        {
            !show ?
            <Image src={Hamburger} width={22.75} height={13} />
            : null
        }
      </div>
      {show ? (
          <div className={styles.show_hamburger}>
              <div className={styles.images_display}>
                <Image src={Logo} width={24.44} height={22.18} />
                <Image onClick={cancel} src={Cancel} width={18.75} height={18.17} />
              </div>
            <p>Stay Updated</p>
            <p>Sponsorship/Partnership</p>
          </div>
